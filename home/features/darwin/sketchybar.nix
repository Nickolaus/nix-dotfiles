...
lib.mkIf pkgs.stdenv.isDarwin {
  ...
  home.file.".config/sketchybar/sketchybarrc" = {
    text = ''
      ...
      #
      # Explicitly set position and topmost to ensure proper space reservation
      sketchybar --bar position=top topmost=off sticky=on display=all height=24 notch_display_height=42 blur_radius=30 color=0xaa000000
  ...
  # AeroSpace space plugin (official integration)
